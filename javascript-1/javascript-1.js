...
//CODE HERE
let phone1 = new Phone('Apple', 'iPhone 7 plus', 32, 'rose gold', false)
  
let phone2 = new Phone('Apple', 'iPhone 12 Max', 256, 'black', false) 
  
let phone3 = new Phone('Samsung', 'Galaxy S10+', 512, 'white', false)
